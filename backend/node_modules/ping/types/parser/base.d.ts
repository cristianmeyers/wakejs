 ...
 */
declare function Parser(addr: string, config: import("ping").PingConfig): void;
declare class Parser {
     ...
     * @param {import('../index').PingConfig} config - Config object in probe()
     */
    constructor(addr: string, config: import("ping").PingConfig);
    _state: number;
    /**
    ...
    _lines: any[];
    _stripRegex: RegExp;
    _pingConfig: import("ping").PingConfig;
    /**
