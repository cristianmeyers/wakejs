 ...
 */
export type probeCallback = (response: import("ping/types/parser/base").PingResponse, error: Error | null) => any;
/**
 ...
 */
export function probe(addr: string, cb: probeCallback, config?: import("ping").PingConfig): Promise<import("ping/types/parser/base").PingResponse>;
